package yf2d.textures.batch
{
	...
	public class TextureScroll extends Texture2D implements ITextureScroll
	{
		...
		override public function getUVData(scaleX:Number=1):Vector.<Number>
		{
			if(invalidUV)
			{
		...
		/**显示的对象的大小
		 */		
		override public function get textureRect():Rectangle{	return 	new Rectangle(ltPoint.x,ltPoint.y,viewWidth,viewHeight)	}
