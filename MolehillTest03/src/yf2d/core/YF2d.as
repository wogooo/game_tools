package yf2d.core
{
	...
	public final class YF2d
	{
		...
		public function initData(stage:Stage,stageWidth:Number,stageHeight:Number,bgColor:uint=0xFFFFFF,materialId:int=1):void
		{
			this.stage=stage;
			...
			initContext();
			configureStage();
			interaction=new Interaction(stage,scence)
		...
		private function onContextRequest(e:Event):void
		{
			...
			scence.x=stage3d.x;                  
			scence.y=stage3d.y;
			resizeScence(stageWidth,stageHeight);
