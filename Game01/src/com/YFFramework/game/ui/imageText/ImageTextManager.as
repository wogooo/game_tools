package com.YFFramework.game.ui.imageText
{
	...
	public class ImageTextManager
	{
		 ...
		 */
		public   function createNum(num:String,id:int=1):AbsUIPool
		{
			var str:String=num;
			var arr:Array=str.split("");
			var myNum:int;
			var sp:AbsUIPool=PoolCenter.Instance.getFromPool(AbsUIPool) as AbsUIPool;
			var data:BitmapData;
			var lastX:int=0;
			var bmp:Bitmap;
			for each (str in arr)
		 ...
		 * @return 
		 */
		public  function createNumWidthPre(num:String,id:int=1):AbsUIPool
		{
			var str:String=num;
			var arr:Array=str.split("");
			var myNum:int;
		...
		/**创建文本
		 */ 
		public function createText(textId:int):AbsUIPool
		{
			var bitmapData:BitmapData=_dict[Text][textId] ;
			var ui:AbsUIPool=PoolCenter.Instance.getFromPool(AbsUIPool) as AbsUIPool;
		 ...
		 */		
		public function createTextNum(textId:int,num:String,numSkinId:int):AbsUIPool
		{
			var sp:AbsUIPool=PoolCenter.Instance.getFromPool(AbsUIPool) as AbsUIPool;
			var lastX:int=0;
