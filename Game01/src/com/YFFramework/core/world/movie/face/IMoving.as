package com.YFFramework.core.world.movie.face
{
	...
	public interface IMoving
	{
		 ...
		 * @param completeParam
		 */
		function sMoveTo(path:Array,speed:int=5,completeFunc:Function=null,completeParam:Object=null,forceUpdate:Boolean=false):void;
		/** 移动到目标点 mapX  mapY 
		 * @param mapX
		 * @param mapY
		 * @param speed
		...
		function moveTo(mapX:int,mapY:int,speed:int=4,completeFunc:Function=null,completeParam:Object=null,forceUpdate:Boolean=false,breakFunc:Function=null,breakParam:Object=null):void;
		/**  设置 地图坐标
		 * @param mapX
		 * @param mapY
		 * 
