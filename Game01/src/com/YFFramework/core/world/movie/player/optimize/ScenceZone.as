package com.YFFramework.core.world.movie.player.optimize
{
	...
	public class ScenceZone
	{
		...
		//		{
		//			var node:PlayerNode=_dict[player.getID()];
		...
		//		{
		//			var playerNode:PlayerNode=_dict[player.getID()];
		//			if(playerNode)
		//			{
		//				delNode(playerNode);
		//				return true;
		...
		public function addNode(playerNode:PlayerNode):void
		{
			...
			if(playerNode.zone&&playerNode.zone!=this)
			{
				...
				if(_dict[player.getID()]==null)
				{
					_dict[player.getID()]=playerNode;
