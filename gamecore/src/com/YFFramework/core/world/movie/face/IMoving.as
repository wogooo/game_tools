package com.YFFramework.core.world.movie.face
{
	...
	public interface IMoving
	{
		...
		function moveTo(mapX:Number,mapY:Number,speed:Number=4,completeFunc:Function=null,completeParam:Object=null):void;
		/**  设置 地图坐标
		 * @param mapX
		 * @param mapY
		 * 
		 */
		function setMapXY(mapX:Number,mapY:Number):void;
	}
}