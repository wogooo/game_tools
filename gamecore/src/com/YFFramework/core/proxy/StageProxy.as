package com.YFFramework.core.proxy
{
	...
	public final class StageProxy
	{
		...
		public var mouseUp:FuncCollection;
		public var mouseDown:FuncCollection;
		public function StageProxy()
		{
			ResizeManager.Instance.regFunc(updateViewPort);
			mouseUp=new FuncCollection();
			mouseDown=new FuncCollection();
		}
		...
		/**注册鼠标 释放
		 */		
		public function regStageMouseUp():void
		{
		 ...
		 * 
		 */		
		public function regStageMouseDown():void
		{
