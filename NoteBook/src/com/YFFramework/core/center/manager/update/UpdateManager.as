package com.YFFramework.core.center.manager.update
{
	...
	//	public var frame45:UpdateFrame;
		...
		private var updateCoreDict:Vector.<UpdateCore>;
		...
		{
			updateCoreDict=new Vector.<UpdateCore>();
...
//				}
	...
	//		frame45.update();
			...
			///检测临时注册
			for each (var updateCore:UpdateCore in updateCoreDict)
		...
		/**注册需要更新的函数
		 */		
		public function  regUpdateCore(func:UpdateCore):void
		{
		...
		/** 卸载更新函数
		 */		
		public function  delUpdateCore(func:UpdateCore):void
		{
			var index:int=updateCoreDict.indexOf(func);
