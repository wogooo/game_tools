package com.YFFramework.core.ui.yfComponent.controls
{
	...
	import com.notebook.ui.layer.PopUpManager;
	...
	public class YFAlert extends YFPane
	{
		...
		public function YFAlert(message:String="",tittle:String="提示",flags:int=1,okFunc:Function=null,cancelFunc:Function=null,okFuncParam:Object=null,cancelFuncparam:Object=null,label1:String=null,label2:String=null)
		{
			_msg=message;
			_tittle=tittle;
			_flags=flags;
			...
			_label1=label1;
			_label2=label2;
			if(!_label1)_label1="确定";
			if(!_label2)_label2="取消";
			super(200,200,true);
		}
		...
		override protected function initUI():void
		{
			...
			{
				_btnOK=new YFButton(_label1,2);	
				_btnCancel=new YFButton(_label2,2);
				addChild(_btnOK);
				addChild(_btnCancel);
		 ...
		 * 
		 */		
		public static function show(message:String="",tittle:String="提示",flags:int=1,okFunc:Function=null,cancelFunc:Function=null,okFuncParam:Object=null,cancelFuncParam:Object=null,label1:String=null,label2:String=null):void
		{
			var alert:YFAlert=new YFAlert(message,tittle,flags,okFunc,cancelFunc,okFuncParam,cancelFuncParam,label1,label2);
