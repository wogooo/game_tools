...
{  
	...
	public class PreLoading3 extends Sprite
	{
...
//		private static const LoadingBarHeight:int=60;
		/** socket文本
		 */
...
//			ConfigManager.Instance.webHost=appRoot+"/"+ConfigManager.Instance.gameGate;
