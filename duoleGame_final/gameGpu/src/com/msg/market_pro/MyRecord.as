package com.msg.market_pro {
	...
	public dynamic final class MyRecord extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RECORD_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.market_pro.MyRecord.record_id", "recordId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PROP:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.msg.market_pro.MyRecord.prop", "prop", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.msg.item.CharacterProps; });
		 ...
		 *  @private
		 */
		public static const EQUIP:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.msg.market_pro.MyRecord.equip", "equip", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.msg.item.CharacterEquip; });
		 ...
		 *  @private
		 */
		public static const ITEM_TYPE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.market_pro.MyRecord.item_type", "itemType", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ITEM_TMPL_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.market_pro.MyRecord.item_tmpl_id", "itemTmplId", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const NUMBER:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.market_pro.MyRecord.number", "number", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const UNIT_PRICE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.market_pro.MyRecord.unit_price", "unitPrice", (7 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PRICE_TYPE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.market_pro.MyRecord.price_type", "priceType", (8 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const SALE_TIME:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.market_pro.MyRecord.sale_time", "saleTime", (9 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const STATUS:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.market_pro.MyRecord.status", "status", (10 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const SALE_MONEY_TYPE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.market_pro.MyRecord.sale_money_type", "saleMoneyType", (11 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, this.saleTime);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (record_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: MyRecord.recordId cannot be set twice.');
					}
					++record_id$count;
				...
				case 2:
					if (prop$count != 0) {
						throw new flash.errors.IOError('Bad data format: MyRecord.prop cannot be set twice.');
					}
					++prop$count;
				...
				case 3:
					if (equip$count != 0) {
						throw new flash.errors.IOError('Bad data format: MyRecord.equip cannot be set twice.');
					}
					++equip$count;
				...
				case 4:
					if (item_type$count != 0) {
						throw new flash.errors.IOError('Bad data format: MyRecord.itemType cannot be set twice.');
					}
					++item_type$count;
				...
				case 5:
					if (item_tmpl_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: MyRecord.itemTmplId cannot be set twice.');
					}
					++item_tmpl_id$count;
				...
				case 6:
					if (number$count != 0) {
						throw new flash.errors.IOError('Bad data format: MyRecord.number cannot be set twice.');
					}
					++number$count;
				...
				case 7:
					if (unit_price$count != 0) {
						throw new flash.errors.IOError('Bad data format: MyRecord.unitPrice cannot be set twice.');
					}
					++unit_price$count;
				...
				case 8:
					if (price_type$count != 0) {
						throw new flash.errors.IOError('Bad data format: MyRecord.priceType cannot be set twice.');
					}
					++price_type$count;
					this.priceType = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 9:
					if (sale_time$count != 0) {
						throw new flash.errors.IOError('Bad data format: MyRecord.saleTime cannot be set twice.');
					}
					++sale_time$count;
					this.saleTime = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 10:
					if (status$count != 0) {
						throw new flash.errors.IOError('Bad data format: MyRecord.status cannot be set twice.');
					}
					++status$count;
				...
				case 11:
					if (sale_money_type$count != 0) {
						throw new flash.errors.IOError('Bad data format: MyRecord.saleMoneyType cannot be set twice.');
					}
