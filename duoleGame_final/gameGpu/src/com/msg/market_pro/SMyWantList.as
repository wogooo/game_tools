package com.msg.market_pro {
	...
	public dynamic final class SMyWantList extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RECORD_ARR:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("com.msg.market_pro.SMyWantList.record_arr", "recordArr", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.msg.market_pro.MyRecord; });
