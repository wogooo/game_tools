package com.msg.chat {
	...
	public dynamic final class SGetContactRsp extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const CONTACTS:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("com.msg.chat.SGetContactRsp.contacts", "contacts", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.msg.chat.Contact; });
