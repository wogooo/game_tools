package com.msg.login {
	...
	public dynamic final class PlayerInfo extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const TITLE_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.login.PlayerInfo.title_id", "titleId", (19 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const FIGHT_MODE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.login.PlayerInfo.fight_mode", "fightMode", (20 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const VIP_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.login.PlayerInfo.vip_level", "vipLevel", (29 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const VIP_TYPE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.login.PlayerInfo.vip_type", "vipType", (30 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const FUNC_OPEN:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.login.PlayerInfo.func_open", "funcOpen", (31 << 3) | com.netease.protobuf.WireType.VARINT);

		private var func_open$field:int;

		private var hasField$0:uint = 0;

		public function clearFuncOpen():void {
			hasField$0 &= 0xfffffffe;
			func_open$field = new int();
		}

		public function get hasFuncOpen():Boolean {
			return (hasField$0 & 0x1) != 0;
		}

		public function set funcOpen(value:int):void {
			hasField$0 |= 0x1;
			func_open$field = value;
		}

		public function get funcOpen():int {
			return func_open$field;
		}

		/**
		 *  @private
		 */
		public static const GAME_VIP:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.login.PlayerInfo.game_vip", "gameVip", (32 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, this.titleId);
			com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 20);
			com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, this.fightMode);
			...
			com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, this.vipType);
			if (hasFuncOpen) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 31);
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, func_open$field);
			}
			com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 32);
			com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, this.gameVip);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			var fight_mode$count:uint = 0;
			var vip_level$count:uint = 0;
			var vip_type$count:uint = 0;
			var func_open$count:uint = 0;
			var game_vip$count:uint = 0;
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 19:
					if (title_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: PlayerInfo.titleId cannot be set twice.');
					}
					++title_id$count;
					this.titleId = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 20:
					if (fight_mode$count != 0) {
						throw new flash.errors.IOError('Bad data format: PlayerInfo.fightMode cannot be set twice.');
					}
					++fight_mode$count;
					this.fightMode = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 29:
				...
				case 30:
					if (vip_type$count != 0) {
						throw new flash.errors.IOError('Bad data format: PlayerInfo.vipType cannot be set twice.');
					}
					++vip_type$count;
					this.vipType = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 31:
					if (func_open$count != 0) {
						throw new flash.errors.IOError('Bad data format: PlayerInfo.funcOpen cannot be set twice.');
					}
					++func_open$count;
					this.funcOpen = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 32:
					if (game_vip$count != 0) {
						throw new flash.errors.IOError('Bad data format: PlayerInfo.gameVip cannot be set twice.');
					}
					++game_vip$count;
					this.gameVip = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				default:
