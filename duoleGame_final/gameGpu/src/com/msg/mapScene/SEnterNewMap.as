package com.msg.mapScene {
	...
	public dynamic final class SEnterNewMap extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const CAMP:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.mapScene.SEnterNewMap.camp", "camp", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 4:
					if (camp$count != 0) {
						throw new flash.errors.IOError('Bad data format: SEnterNewMap.camp cannot be set twice.');
					}
					++camp$count;
