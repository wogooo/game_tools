package com.msg.task {
	...
	public dynamic final class SDelAcptTaskList extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const TASK_LIST:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("com.msg.task.SDelAcptTaskList.task_list", "taskList", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.msg.task.TaskInf; });
