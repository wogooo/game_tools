package com.msg.sys {
	...
	public dynamic final class SAutoConfigRead extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const CONFIG_BOOL_ARR:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("com.msg.sys.SAutoConfigRead.config_bool_arr", "configBoolArr", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.msg.sys.ConfigBool; });
		 ...
		 *  @private
		 */
		public static const CONFIG_INT_ARR:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("com.msg.sys.SAutoConfigRead.config_int_arr", "configIntArr", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.msg.sys.ConfigInt; });
