package com.msg.pets {
	...
	public dynamic final class SInheritPet extends com.netease.protobuf.Message {
		...
		private var remove_pet_id$field:int;

		private var hasField$0:uint = 0;

		public function clearRemovePetId():void {
			hasField$0 &= 0xfffffffe;
			remove_pet_id$field = new int();
		}

		public function get hasRemovePetId():Boolean {
			return (hasField$0 & 0x1) != 0;
		}

		public function set removePetId(value:int):void {
			hasField$0 |= 0x1;
			remove_pet_id$field = value;
		}

		public function get removePetId():int {
			return remove_pet_id$field;
		}
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasRemovePetId) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, remove_pet_id$field);
			}
