package com.msg.item {
	...
	public dynamic final class CharacterProps extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const BINDING_ATTR:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.msg.item.CharacterProps.binding_attr", "bindingAttr", (4 << 3) | com.netease.protobuf.WireType.VARINT, com.msg.enumdef.BindingType);
		 ...
		 *  @private
		 */
		public static const OBTAIN_TIME:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.item.CharacterProps.obtain_time", "obtainTime", (5 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 4:
					if (binding_attr$count != 0) {
						throw new flash.errors.IOError('Bad data format: CharacterProps.bindingAttr cannot be set twice.');
					}
					++binding_attr$count;
