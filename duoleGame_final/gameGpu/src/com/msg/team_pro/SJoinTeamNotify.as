package com.msg.team_pro {
	...
	public dynamic final class SJoinTeamNotify extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const JOIN_REQUESTER:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.msg.team_pro.SJoinTeamNotify.join_requester", "joinRequester", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.msg.team_pro.MemberInfo; });

		public var joinRequester:com.msg.team_pro.MemberInfo;
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					this.joinRequester = new com.msg.team_pro.MemberInfo();
