package com.msg.team_pro {
	...
	public dynamic final class STeamInviteNotify extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const INVITOR_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.msg.team_pro.STeamInviteNotify.invitor_info", "invitorInfo", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.msg.team_pro.MemberInfo; });

		public var invitorInfo:com.msg.team_pro.MemberInfo;
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					++invitor_info$count;
					this.invitorInfo = new com.msg.team_pro.MemberInfo();
