	...
	public class FightEffectBasicManager
	{
		...
		public  function cacheData(jsonData:Object):void
		{
			...
			for (var id:String in jsonData)
			{
				...
				fightEffectBasicVo.speed=jsonData[id].speed/UpdateManager.UpdateRate;
...
//				fightEffectBasicVo.atkSkyOffsetY=jsonData[id].atkSkyOffsetY;
				...
				fightEffectBasicVo.atkSkyOffset=jsonData[id].atkSkyOffset;
				fightEffectBasicVo.atkSkySkillLen=jsonData[id].atkSkySkillLen;
				...
				fightEffectBasicVo.bloodArr=jsonData[id].bloodArr;
				
				fightEffectBasicVo.bgFloorId=jsonData[id].bgFloorId;
				fightEffectBasicVo.bgFloorTimeArr=jsonData[id].bgFloorTimeArr;
				fightEffectBasicVo.particle_id=jsonData[id].particle_id;


				fightEffectBasicVo.initSkyOffset();
