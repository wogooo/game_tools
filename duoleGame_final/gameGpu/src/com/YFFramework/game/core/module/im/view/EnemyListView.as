package com.YFFramework.game.core.module.im.view
{
	...
	/**仇人列表
	 *@author yefeng
	 * 2013 2013-6-28 上午10:45:44 
	 */
	public class EnemyListView extends AbsUserListView
	{
		public function EnemyListView()
		{
		}
		
		/**初始化菜单  私聊 删除 好友 黑名单 观察 密语 组队 复制姓名 邀请入会
		 */		
		...
		private function onMenuClick(index:uint,label:String):void
		{
			...
			switch(index) 
			{
				case 0:	//私聊
					...
					break;
				case 1:		//删除  敌人
					YFEventCenter.Instance.dispatchEventWith(IMEvent.C_DeleteEnemy,imDyVo.dyId);  //
					break;
				case 2:	//好友
					var privateTalkRequestVo:PrivateTalkPlayerVo=new PrivateTalkPlayerVo();
					privateTalkRequestVo.dyId=imDyVo.dyId;
					privateTalkRequestVo.name=imDyVo.name;
					YFEventCenter.Instance.dispatchEventWith(IMEvent.C_AddFriend,privateTalkRequestVo);
					break;
				case 3:		//观察
