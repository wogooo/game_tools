package com.YFFramework.game.core.module.rank.view
{
	...
	public class RankPageList extends PageItemListBase
	{
		//======================================================================
		//       public property
		//======================================================================
...
//			UI.removeAllChilds(_medal);
		...
		private function initRoleVip(vipper:Sprite,vo:RankDyVo,txt:TextField):void
		{
		...
		override protected function disposeItem(view:Sprite):void
		{
			_vipper1=Xdis.getChild(view,"vipper1");
			_vipper2=Xdis.getChild(view,"vipper2");
			if(_vipper1.numChildren>0)
			{
				_vipBtn=_vipper1.getChildAt(0) as MovieClip;
				_vipBtn.removeEventListener(MouseEvent.CLICK,onVipClick);
			}	
			else if(_vipper2.numChildren>0)
			{
				_vipBtn=_vipper2.getChildAt(0) as MovieClip;
				_vipBtn.removeEventListener(MouseEvent.CLICK,onVipClick);
			}
			UI.removeAllChilds(_vipper1);
			UI.removeAllChilds(_vipper2);
