package com.YFFramework.game.core.module.market.view.panel.purchase
{
	 ...
	 * 市场窗口下——求购面板
	 * @version 1.0.0
	 * creation time：2013-5-28 上午10:15:39
	 * 
	 */
	public class PurchasePanel extends EventDispatcher
	{
		//======================================================================
		//       public property
		//======================================================================
...
//		private var _moneyBtn:SimpleButton;
		...
		/**我的求购按钮  */		
		private var _myPurchaseBtn:Button;
		/**自定义变量  */		
...
//		private var _curMoney:int;//当前货币类型
		...
		public function PurchasePanel(mc:MovieClip)
		{
			_mc=mc.view;
//			_purchaseItemWindow=purchaseItemWin;
...
//			_hotSaleBtn8.textField.y=4;
			...
			//求购按钮
			_purchaseBtn=Xdis.getChild(_mc,"action_button");
			_purchaseBtn.label='求购';
			_purchaseBtn.addEventListener(MouseEvent.CLICK,onPurchase);
			
			//我的求购
			_myPurchaseBtn=Xdis.getChild(_mc,"my_button");
			_myPurchaseBtn.label='我的求购';
			_myPurchaseBtn.addEventListener(MouseEvent.CLICK,onMyPurchase);
...
//			_curMoney=MarketSource.MONEY_ALL;
		...
		{	
			var msg:CSearchWantList =new CSearchWantList();
...
//			}		
			...
			YFEventCenter.Instance.dispatchEventWith(MarketEvent.CSearchWantList,msg);
		...
		{	
			...
			if(_totalPage > 0)//有记录
			{				
				_items.initConsignPurchaseData(MarketSource.PURCHASE);
			}
...
//		private function onHotSale1(e:MouseEvent):void
//		{
//			var ary:Array=
//				_tree.findDataIndex(MarketTypeConfigBasicManager.Instance.getInfoBySubType(MarketSource.HOT_SALE1).subClassic_type,
//					"subType");
//			hotSaleContrl(ary);	
//		}
//		
//		private function onHotSale2(e:MouseEvent):void
//		{
//			var ary:Array=
//				_tree.findDataIndex(MarketTypeConfigBasicManager.Instance.getInfoBySubType(MarketSource.HOT_SALE2).subClassic_type,
//					"subType");
//			hotSaleContrl(ary);
//		}
//		
//		private function onHotSale3(e:MouseEvent):void
//		{
//			var ary:Array=
//				_tree.findDataIndex(MarketTypeConfigBasicManager.Instance.getInfoBySubType(MarketSource.HOT_SALE3).subClassic_type,
//					"subType");
//			hotSaleContrl(ary);
//		}
//		
//		private function onHotSale4(e:MouseEvent):void
//		{
//			var ary:Array=
//				_tree.findDataIndex(MarketTypeConfigBasicManager.Instance.getInfoBySubType(MarketSource.HOT_SALE4).subClassic_type,
//					"subType");
//			hotSaleContrl(ary);
//		}
//		
//		private function onHotSale5(e:MouseEvent):void
//		{
//			var ary:Array=
//				_tree.findDataIndex(MarketTypeConfigBasicManager.Instance.getInfoBySubType(MarketSource.HOT_SALE5).subClassic_type,
//					"subType");
//			hotSaleContrl(ary);
//		}
//		
//		private function onHotSale6(e:MouseEvent):void
//		{
//			var ary:Array=
//				_tree.findDataIndex(MarketTypeConfigBasicManager.Instance.getInfoBySubType(MarketSource.HOT_SALE6).subClassic_type,
//					"subType");
//			hotSaleContrl(ary);
//		}
//		
//		private function onHotSale7(e:MouseEvent):void
//		{
//			var ary:Array=
//				_tree.findDataIndex(MarketTypeConfigBasicManager.Instance.getInfoBySubType(MarketSource.HOT_SALE7).subClassic_type,
//					"subType");
//			hotSaleContrl(ary);
//		}
//		
//		private function onHotSale8(e:MouseEvent):void
//		{
//			var ary:Array=
//				_tree.findDataIndex(MarketTypeConfigBasicManager.Instance.getInfoBySubType(MarketSource.HOT_SALE8).subClassic_type,
//					"subType");
//			hotSaleContrl(ary);
//		}
		...
		{
			if(PurchaseItemWindow.instance.isOpen == false)
			{
				PurchaseItemWindow.instance.open();
				PurchaseItemWindow.instance.openPanel(1);
			}
			else
			{
				if(PurchaseItemWindow.instance.getTabIndex() == 2)
				{
					PurchaseItemWindow.instance.openPanel(1);
		...
		private function onMyPurchase(e:MouseEvent):void
		{
			if(PurchaseItemWindow.instance.isOpen == false)
			{
				PurchaseItemWindow.instance.open();
				PurchaseItemWindow.instance.switchToTop();
				PurchaseItemWindow.instance.openPanel(2);
			}
			else
			{
