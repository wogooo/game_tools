...
//			this.mouseEnabled = false;
			...
			_renderWidth = _ui.width;
			_renderHeight = _ui.height;
			...
			if(_txt)	_txt.mouseEnabled = false;
		...
		protected function updateView(item:Object):void{
			...
			if(_txt && value.hasOwnProperty("label"))	_txt.htmlText = value.label;
		...
		public function set list(value:List):void{
			_list = value;
			if(_txt)	_txt.filters = _list.textFilters;
		}
