package com.YFFramework.core.yf2d.display.sprite2D
{
	...
	public class ATFClip extends DisplayObjectContainer2D
	{
		...
		private var _spriteClipData:SpriteClipData;
		...
		/**某一帧的数据
		 */
		public function getClipData():SpriteClipData
		{
			if(!_spriteClipData)
			{
				_spriteClipData=new SpriteClipData();
			}
			_spriteClipData.bitmapFrameData=_movie.texture as ATFBitmapFrame;
			_spriteClipData.scaleX=_movie.getTextureScaleX();
			_spriteClipData.scaleY=_movie.getTextureScaleY();
			_spriteClipData.flashTexure=_movie.getFlashTexture();
			return _spriteClipData;
		}
