package com.YFFramework.core.yf2d.events
{
	
	import flash.utils.getQualifiedClassName;
	
	import com.YFFramework.core.yf2d.utils.formatString;
	...
	public class YF2dEvent
    {
		 ...
		 * context3d  第一次创建
		 */		
		public static const CONTEXT_First_CREATE:String="CONTEXT_First_CREATE";
		/** context3d重复创建  开始 创建 YF2dActionData
		 */		
		public static const CONTEXT_Re_CREATE_InitActionData:String="CONTEXT_Re_CREATE_InitActionData";
		/**context3d重复创建  开始 重置YF2dMovieClip 动画    是先发送 CONTEXT_Re_CREATE_InitActionData ,在发送CONTEXT_Re_CREATE_InitMovieClip
		 */		
		public static const CONTEXT_Re_CREATE_InitMovieClip:String="CONTEXT_Re_CREATE_InitMovieClip";
