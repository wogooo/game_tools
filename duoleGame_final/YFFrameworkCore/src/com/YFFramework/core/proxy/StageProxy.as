...
//					trace("鼠标点击对象:",e.target.name)
		...
		/**无焦点
		 */		
		public  function setNoneFocus():void
		{
			stage.focus=null;
			IME.enabled=false;
		}
