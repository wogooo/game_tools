package com.YFFramework.core.utils.image
{
	...
	public class BitmapDataUtil
	{
		 ...
		 * 
		 */		
		public static function   getValideBitmapData(bitmapData:BitmapData):LowMapData
		{
			var obj:LowMapData=new LowMapData();
			...
			else 
			{
				...
				obj.u=bitmapData.width/copy.width;
				obj.v=bitmapData.height/copy.height;
				obj.bitmapData=copy;
				bitmapData.dispose();
			}
			return obj;
