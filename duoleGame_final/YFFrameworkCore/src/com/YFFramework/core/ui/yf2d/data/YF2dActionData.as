package com.YFFramework.core.ui.yf2d.data
{
	...
	public class YF2dActionData
	{
		...
		/**获取已经生存材质的movieData
		 */
		public function getAvaibleMovieData():MovieData
		{
			var movieData:MovieData;
			for each(var action :int in getActionArr())
			{
				for each (var direction :int  in getDirectionArr(action))
				{
					movieData=dataDict[action][direction];
					if(movieData.getTexture())
					{
						return movieData;	
					}
				}
