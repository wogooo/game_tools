...
//				var mc:MovieClip=_style.link as MovieClip;
				...
				var mc:MovieClip=ClassInstance.getInstance("ItemCD");
...
//			_style=null;
		...
		public function clone():YFCDData
		{
			var cd:YFCDData=new YFCDData();
			cd.start();
			cd.play(_frameRate,getPlayIndex(),_loop,_completeFunc,_completeParam);
			return cd;
		}
