package com.YFFramework.core.net.loader.file
{
	...
	public   class FileLoader
	{
		...
		protected function onError(e:IOErrorEvent):void
		{
			...
			LoadErrorLog.Instance.add("加载发生流错误，错误地址为:"+request.url);
			remove();
		...
		protected function onProgress(e:ProgressEvent):void
		{
			...
			{
				if(progressCallBack.length==1)progressCallBack(e);
				else if(progressCallBack.length==2)progressCallBack(e,_tmpData);
			}
		}
