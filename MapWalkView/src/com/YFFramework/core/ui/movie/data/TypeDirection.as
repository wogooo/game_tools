package com.YFFramework.core.ui.movie.data
{
	...
	public class TypeDirection
	{
		...
		/** 死亡默认动作
		 */		
		public static const DeafultDead:int=1;
		
		/** 方向长度
		 */		
		public static const DirectionLen:int=8;
		...
		/**得到镜像方向    也就是 scaleX 和 该scaleX对应的镜像方向
		 */ 
		public static function getCopyDirection(direction:int):Object
		{
...
//					break;
			...
			return {direction:direction,scaleX:scaleX}
		}
