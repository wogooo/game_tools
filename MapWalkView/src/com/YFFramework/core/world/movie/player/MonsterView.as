package com.YFFramework.core.world.movie.player
{
	...
	public class MonsterView extends PlayerView
	{
		...
		override public function addBloodText(num:int,curentHp:int,timeArr:Array,completeFunc:Function=null,param:Object=null):void
		{
			ImageUtil.Instance.showBloodEx(timeArr,num,x,y,TypeImageText.Num_Red,completeFunc,param);
			if(roleDyVo)
			{
