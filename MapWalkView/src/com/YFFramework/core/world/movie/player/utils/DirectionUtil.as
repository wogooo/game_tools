...
//		}
		...
		public static function isInSector(heroCenterX:int,heroCenterY:int,direction:int,radius:int,jiaodu:int,otherCenterX:int,otherCenterY:int):Boolean
		{
			...
			if(dis<=radius)  ///在圆内
			{
				...
				var line1:int=heroDegree+jiaodu*0.5; ///大的一条线的角度
				var line2:int=heroDegree-jiaodu*0.5 ;//小的一条线的角度
				var otherRoleJiaodu:int=YFMath.getDegree(heroCenterX,heroCenterY,otherCenterX,otherCenterY); ///其他角色的角度
