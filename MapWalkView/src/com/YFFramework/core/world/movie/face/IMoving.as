package com.YFFramework.core.world.movie.face
{
	...
	public interface IMoving
	{
		...
		function moveTo(mapX:int,mapY:int,speed:Number=4,completeFunc:Function=null,completeParam:Object=null,forceUpdate:Boolean=false,breakFunc:Function=null,breakParam:Object=null):void;
		/**  设置 地图坐标
		 * @param mapX
		 * @param mapY
		 * 
