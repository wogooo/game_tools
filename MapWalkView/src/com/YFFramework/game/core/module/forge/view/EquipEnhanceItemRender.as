package com.YFFramework.game.core.module.forge.view
{
	 ...
	 * 
	 */
	public class EquipEnhanceItemRender extends ListRenderBase
	{
		private var _nameTxt:TextField;
		private var _moneyTxt:TextField;
		private var _iconImage:IconImage;
		
		public function EquipEnhanceItemRender()
		{
		...
		override protected function updateView(item:Object):void
		{
			...
			_moneyTxt.text = String(PropsDyManager.instance.getPropsQuantity(vo.template_id));
			if(item.isIn == false){
				UI.setEnable(this,false,false);
			}
		}
