package com.msg.storage {
	...
	public dynamic final class CGetDepotInfReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const APPEND:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.msg.storage.CGetDepotInfReq.append", "append", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (append$count != 0) {
						throw new flash.errors.IOError('Bad data format: CGetDepotInfReq.append cannot be set twice.');
					}
					++append$count;
