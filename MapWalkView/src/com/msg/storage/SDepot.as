package com.msg.storage {
	...
	public dynamic final class SDepot extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const CELL:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("com.msg.storage.SDepot.cell", "cell", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.msg.storage.Cell; });
		 ...
		 *  @private
		 */
		public static const CLEAR_ALL:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("com.msg.storage.SDepot.clear_all", "clearAll", (2 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					if (clear_all$count != 0) {
						throw new flash.errors.IOError('Bad data format: SDepot.clearAll cannot be set twice.');
					}
					++clear_all$count;
