package com.dolo.ui.controls
{
	...
	{
		public static var listLinkage:String = "UISkinList";
		...
		protected function popList(event:MouseEvent):void
		{
			...
			if(_list.compoWidth != popWidht || _list.compoHeight != _rowCount*listItemHeight ){
