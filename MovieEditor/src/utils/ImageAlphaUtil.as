...
{  
	...
	public class ImageAlphaUtil
	{
		 ...
		 * @param data_ra   透明通道保存在 blue 通道 的BitmapData对象 
		 * @return 具有透明通道的像素源
		 */		
		 ...
		 * 返回  [rbg_bitmapData,ba_bitmapData]
		 */		
		...
		/**获取透明通道的图片   非透明的地方是红色
		 */
		public static function getRaData(pngBitmapData:BitmapData,bgColor:uint=0xFFFFFF):BitmapData
		{
			var rect:Rectangle=new Rectangle(0,0,pngBitmapData.width,pngBitmapData.height);
