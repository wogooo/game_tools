package manager
{
	...
	/**生成 java android 平台的格式文件   由  json 和  图片组成
	 */	
	public class AndroidDataManager
	{
		/** ad 文件加载完成
		 */ 
		public static const AndroidDataComplete:String="AndroidDataComplete";
		private static  var _dict:Dictionary=new Dictionary();

		public function AndroidDataManager()
		{
		}
		...
		/** 创建 ad文件  android 文件
		 */		
		public static function createAndroidData(actionData:ActionData,dir:File,fileName:String):void
		{
			...
			///将headObj转化为json
			var headerStr:String=JSON.stringify(header);
		...
		private static  function complete(loader:BytesLoader,domain:ApplicationDomain):void
		{
			...
			{
				YFEventCenter.Instance.dispatchEventWith(AndroidDataComplete,{actionData:actionData,flag:_dict[actionData].flag});
