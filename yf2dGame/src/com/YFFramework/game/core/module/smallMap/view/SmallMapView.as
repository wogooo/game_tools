package com.YFFramework.game.core.module.smallMap.view
{
	...
	{ 
		 ...
		 * @param dyId  npc id
		 */		
		public function closeToNPC(dyId:String):void
		{
		...
		{
			var mX:Number=HeroProxy.mapX*radio;
			var mY:Number=HeroProxy.mapY*radio;
			_heroMoveArrow.setPivotXY(mX,mY);
			_heroMoveArrow.direction=HeroProxy.direction;
		}
