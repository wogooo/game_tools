package com.YFFramework.core.ui.yf2d.view.avatar
{
	 ...
	 *@author yefeng
	 */
	public class ThingEffect2DView extends YF2dMovieClipPool implements IMoving 
	{
		/**动画基本vo
		 */
		...
		protected function updatePostion(e:YFEvent=null):void
		{
			...
			x =HeroProxy.x+roleDyVo.mapX-HeroProxy.mapX;
			y=HeroProxy.y+roleDyVo.mapY-HeroProxy.mapY;
		}
