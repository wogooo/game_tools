...
//			trace("z执行次数...");
		...
		{
			YF2d.Instance.scence.removeEventListener(YF2dEvent.CONTEXT_CREATE,onContext3dCreate);
			loadConfig();
		}
		...
		/**加载.res文件
		 */		
		private function loadResFile():void
		{
			var resFileLoader:ResFileLoader=new ResFileLoader();
			resFileLoader.loadCompleteCallBack=resLoadComplete;
			resFileLoader.load(ConfigManager.Instance.getResURL());
		}
		private function resLoadComplete(resData:Object):void
		{
