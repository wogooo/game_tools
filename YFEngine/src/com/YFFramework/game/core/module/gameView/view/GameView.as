package com.YFFramework.game.core.module.gameView.view
{
	...
	public class GameView
	{
		...
		//	SWFProfiler.init(StageProxy.Instance.stage,LayerManager.RootView);
			...
			var  label:YFLabel=new YFLabel("硬件加速版本,3w前后端，购买游戏联系qq: 623307507"); 
			label.width=500;
			LayerManager.PopLayer.addChild(label);
			label.y=80;
			label.x=5;
		}
		...
		protected function addEvents():void
		{
			...
			StageProxy.Instance.stage.addEventListener(MouseEvent.MOUSE_DOWN,onRootClick);
			//	LayerManager.BgMapLayer.addEventListener(YF2dMouseEvent.MOUSE_DOWN,onRootClick);
		...
		{
			smallPicUI.__sceneNameTxt.text=HeroProxy.x+"/"+HeroProxy.y;
			smallPicUI.__sceneNameTxt2.text=HeroProxy.mapX+"/"+HeroProxy.mapY;
		}
		/**进入游戏主场景
		 */		
		...
		{
//			YFEventCenter.Instance.dispatchEventWith(GlobalEvent.ScenceClick);
