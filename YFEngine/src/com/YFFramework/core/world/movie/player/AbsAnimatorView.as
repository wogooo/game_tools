package com.YFFramework.core.world.movie.player
{
	...
	public class AbsAnimatorView extends ZonePlayer implements IMoving
	{
		...
		/**  移动 行走 前进
		 */		
		public function moveTo(mapX:int,mapY:int,speed:int=4,completeFunc:Function=null,completeParam:Object=null,forceUpdate:Boolean=false,breakFunc:Function=null,breakParam:Object=null):void
		{
		 ...
		 */ 
		public function backSlideMoveTo(mapX:int,mapY:int,direction:int,speed:int=4,completeFunc:Function=null,completeParam:Object=null,forceUpdate:Boolean=false,breakFunc:Function=null,breakParam:Object=null):void
		{
			_teenBezier.destroy();   
			_tweenSimple.stop();   
		...
		/**单纯的进行移动  不包含动作的播放
		 */ 	
		public function pureMoveTo(mapX:int,mapY:int,speed:int=4,completeFunc:Function=null,completeParam:Object=null,forceUpdate:Boolean=false,breakFunc:Function=null,breakParam:Object=null):void
		{
			_teenBezier.destroy();   
			_tweenSimple.stop();   
			_tweenSimple.tweenTo(this,"_mapX","_mapY",mapX,mapY,speed,completeFunc,completeParam,updatePureMove,new Point(mapX,mapY),forceUpdate,breakFunc,breakParam);
...
//		}
		...
		/** 更新路径移动速度
		 */
		public function updateMovePathSpeed(speed:int):void
		{
		...
		/**停止移动 
		 */
		public function stopMove(direction:int=-1):void
		{
			_teenBezier.destroy();
			_tweenSimple.stop();
			play(TypeAction.Stand,direction);
		}
		/**停止  移动
		 */ 
		...
		{
//			var tx:int=x+_cloth.x*_cloth.scaleX+ClothWidth*0.5;
//			var ty:int=y+_cloth.y+ClothHeight*0.5
		...
		{
			tx=tx-HeroProxy.x+HeroProxy.mapX;
			ty=ty-HeroProxy.y+HeroProxy.mapY
		...
		{
			var px:int=mapX+HeroProxy.x-HeroProxy.mapX;
			var py:int=mapY+HeroProxy.y-HeroProxy.mapY;
...
//				var bmp:BitmapDataEx=_cloth.actionData.getDirectionData(actionArr[0],dirArr[0])[0];
//				pt.x=bmp.bitmapData.width;
//				pt.y=bmp.bitmapData.height;	
