package com.YFFramework.core.movie3d.avartar
{
		...
		public interface IMoving3D
		{
			 ...
			 */
			 ...
			 function moveToPt(mapX:int,mapY:int,speed:int=4,completeFunc:Function=null,completeParam:Object=null,forceUpdate:Boolean=false):void			/**  设置 地图坐标
			 * @param mapX
			 * @param mapY
			 * 
			 */
