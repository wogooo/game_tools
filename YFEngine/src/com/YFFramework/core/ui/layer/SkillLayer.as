package com.YFFramework.core.ui.layer
{
	...
	public class SkillLayer extends Abs2dView
	{
		...
		{
			var movie:ThingRotateEffect2DView=oj as ThingRotateEffect2DView;
			if(contains(movie)) removeChild(movie);
			movie.disposeToPool();
		}
		 ...
		 */ 
		public function addSpeedEffect(pivotX:int,pivotY:int,endX:int,endY:int,speed:int,actionData:YF2dActionData):void
		{
		...
		public function addSuperSpeedEffect(pivotX:int,pivotY:int,endX:int,endY:int,timesArr:Array,speed:int,actionData:YF2dActionData):void
		{			
