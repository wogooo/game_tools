package com.YFFramework.core.ui.yf2d.data
{
	...
	public class BitmapFrameData implements ITextureBase
	{
		...
		/*** movie3D需要使用的UV
		 */ 
		protected var _movie3DUV:Vector.<Number>;
		...
		public function setUVData(vect:Vector.<Number>):void
		{
			...
			var right:Number=_uvData[0]+_uvData[2];
			var bottom:Number=_uvData[1]+_uvData[3];
			_movie3DUV=Vector.<Number>([_uvData[0],_uvData[1],right,_uvData[1],right,bottom,_uvData[0],bottom]);
		}
		
		public function getMovie3DUV():Vector.<Number>
		{
			return _movie3DUV;
		}
