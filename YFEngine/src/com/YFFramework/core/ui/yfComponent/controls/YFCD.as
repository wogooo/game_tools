package com.YFFramework.core.ui.yfComponent.controls
{
	...
	public class YFCD extends AbsUIView
	{
		 ...
		 */		
		public function play(time:Number,loop:Boolean=false,completeFunc:Function=null,completeParam:Object=null):void
		{
			var frate:Number=time/totalFrames;
			_cdView.play(frate,loop,completeFunc,completeParam);
		}
